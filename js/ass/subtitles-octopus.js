    ...
    self.setVideo = function (video) {
        ...
        if (self.video) {
           ...
           const fullscreenResize = () => {
            ...
            document.addEventListener("fullscreenchange", fullscreenResize, false);
            document.addEventListener("mozfullscreenchange", fullscreenResize, false);
            document.addEventListener("webkitfullscreenchange", fullscreenResize, false);
            document.addEventListener("msfullscreenchange", fullscreenResize, false);
